...
void  hs_0_M_51_9__simv_daidir (UB  * pcode, vec32  * I987)
{
    U  I900;
...
void  hs_0_M_87_9__simv_daidir (UB  * pcode, vec32  * I987)
{
    U  I900;
    I900 = *(U  *)((pcode + 0) - sizeof(RP ));
    I987 = (vec32  *)(pcode + 40);
...
void  hs_0_M_88_9__simv_daidir (UB  * pcode, vec32  * I987)
{
    U  I900;
    I900 = *(U  *)((pcode + 0) - sizeof(RP ));
    I987 = (vec32  *)(pcode + 40);
...
void  hs_0_M_104_9__simv_daidir (UB  * pcode, vec32  * I987)
{
    U  I900;
    I900 = *(U  *)((pcode + 0) - sizeof(RP ));
    I987 = (vec32  *)(pcode + 40);
...
void  hs_0_M_105_9__simv_daidir (UB  * pcode, vec32  * I987)
{
    U  I900;
    I900 = *(U  *)((pcode + 0) - sizeof(RP ));
    I987 = (vec32  *)(pcode + 40);
