...
VCS = SW_VCS=2017.12-SP2-1 vcs -cm line+branch+tgl +v2k -sverilog +vc -Mupdate -line -full64 
LIB = /afs/umich.edu/class/eecs470/lib/verilog/lec25dscc25.v

all:    simv
	./simv -cm line+branch+tgl | tee program.out
	urg -dir simv.vdb -format text
##### 
# Modify starting here
#####

TESTBENCH = rs_dummy_test.sv
SIMFILES = verilog/rs.sv
SYNFILES = rs.vg 
TCL = rs.tcl

$(SYNFILES): $(SIMFILES) $(TCL)
	dc_shell-t -f $(TCL) | tee synth.out
